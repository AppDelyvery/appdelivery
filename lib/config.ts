...
export const CONFIG_DEFAULT: Config = {
  ...
  driverPct: 0.8,
  valorParadaExtra: 3, valorEsperaBloco: 4, esperaBlocoMin: 10,
  raioM: 5000,
  pin: null,
  protecaoTeto: 300,
};
...
function mapRow(r: Record<string, unknown> | null): Config {
  ...
  return {
    ...
    valorParadaExtra: num(r.valor_parada_extra, CONFIG_DEFAULT.valorParadaExtra),
    valorEsperaBloco: num(r.valor_espera_bloco, CONFIG_DEFAULT.valorEsperaBloco),
    esperaBlocoMin: num(r.espera_bloco_min, CONFIG_DEFAULT.esperaBlocoMin),
